...
DATADIR = '/home/rashi/Desktop/summer intern 2019/tf_ner-master/data/example'

# Logging
Path('results1').mkdir(exist_ok=True)
tf.logging.set_verbosity(logging.INFO)
handlers = [
    logging.FileHandler('results1/main.log'),
...
if __name__ == '__main__':
    ...
    params = {
        ...
        'kernel_size': 3,
        'lstm_size': 100,
        'words': str(Path('/home/rashi/Desktop/summer intern 2019/tf_ner-master/data/example/vocab.words.txt')),
        'chars': str(Path('/home/rashi/Desktop/summer intern 2019/tf_ner-master/data/example/vocab.chars.txt')),
        'tags': str(Path('/home/rashi/Desktop/summer intern 2019/tf_ner-master/data/example/vocab.tags.txt')),
        'glove': str(Path('/home/rashi/Desktop/summer intern 2019/tf_ner-master/data/example/glove.npz'))
    }
